...
//        /// </summary>
//        protected ConcurrentDictionary<string, TelemetryCounterHolder> mStatusTracker;
//        #endregion
...
//            var items = mCollectors.Where((c) => c.IsSupported(DataCollectionSupport.Logger)).Cast<ILoggerComponent>().Union(mLoggers).ToList();
//            mContainerLogger = new ActionQueueCollection<LogEvent, ILoggerComponent>(items, mPolicy.Logger, ActionQueueEventProcessLog);
