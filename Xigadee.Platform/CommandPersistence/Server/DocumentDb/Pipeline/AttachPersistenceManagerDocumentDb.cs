...
namespace Xigadee
{
    public static partial class CorePipelineExtensions
    {
        ...
        public static C AttachPersistenceManagerDocumentDb<C, K, E>(this C cpipe
            , Func<E, K> keyMaker
        ...
        {
            cpipe.Pipeline.AddPersistenceManagerDocumentDb(keyMaker, keyDeserializer, cpipe, connection, database, startupPriority
