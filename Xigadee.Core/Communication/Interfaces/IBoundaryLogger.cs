...
namespace Xigadee
{
    ...
    public interface IBoundaryLogger
    {
        ...
        void Log(BoundaryLoggerDirection direction, TransmissionPayload payload, Exception ex = null, Guid? batchId = null);
        /// <summary>
    ...
    /// </summary>
    public enum BoundaryLoggerDirection
    {
        /// <summary>
        /// The message has been received from an external fabric.
        /// </summary>
        Incoming,
        /// <summary>
        /// The message has just been transmitted to an external fabric.
        /// </summary>
        Outgoing
    }
}
