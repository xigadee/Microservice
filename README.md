...
and provide a simple and consistent approach when constructing a Microservice-based solution, 
specifically when targeting Platform-as-a-Service (PaaS) technologies in the Azure technology stack. 
