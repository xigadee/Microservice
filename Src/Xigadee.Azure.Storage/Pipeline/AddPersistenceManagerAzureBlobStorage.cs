...
//        public static P AddPersistenceManagerAzureBlobStorage<P,K,E>(this P pipeline
//            , Func<E, K> keyMaker
...
//        {
//            if (keyMaker == null)
//                throw new ArgumentNullException("keyMaker", $"keyMaker cannot be null in {nameof(AddPersistenceManagerAzureBlobStorage)}");
//            if (keyDeserializer == null)
//                throw new ArgumentNullException("keyDeserializer", $"keyDeserializer cannot be null in {nameof(AddPersistenceManagerAzureBlobStorage)}");
//            if (cpipe == null)
//                throw new ArgumentNullException("cpipe", $"cpipe cannot be null in {nameof(AddPersistenceManagerAzureBlobStorage)}");

//            if (credentials == null)
//                credentials = pipeline.Configuration.AzureStorageCredentials(true);

//            var pm = new PersistenceMessageHandlerAzureBlobStorageBase<K,E>(credentials, keyMaker, keyDeserializer
