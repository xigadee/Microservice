...
namespace Xigadee
{
    public static partial class AspNetCoreExtensionMethods
    {
        ...
        public static XigadeeHostedService XigadeeCreate(this IServiceCollection coll
            , string name = null
            , string serviceId = null
            , string description = null
            , IEnumerable<PolicyBase> policy = null
        ...
        public static void XigadeeRegister(this IServiceCollection coll, XigadeeHostedService ms)
        {
