...
//        {          
//            if (await CacheManager.Write(Transform, holder.Rq.Entity))
...
//        {
//            return await CacheManager.Read(Transform, key);
//        }
...
//        {
//            if (await CacheManager.Delete(Transform, reference))
//                return new PersistenceResponseHolder<E> { IsSuccess = true, StatusCode = 200 };
