...
namespace Xigadee
{
    ...
    public class ResourceStatistics: MessagingStatistics, IResourceMetric
    {
        ...
        /// <returns></returns>
        public Guid Start(string name, string group, Guid profileId)
        {
            ActiveIncrement();
            var id = Guid.NewGuid();
        ...
        public void End(string name, Guid profileId, int start, ResourceRequestResult result)
        {
        ...
        public void Retry(string name, Guid profileId, int start, ResourceRetryReason reason)
        {
            ErrorIncrement();
