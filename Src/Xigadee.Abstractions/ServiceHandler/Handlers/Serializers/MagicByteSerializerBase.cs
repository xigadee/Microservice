...
namespace Xigadee
{
    ...
    /// </summary>
    public abstract class MagicByteLegacySerializer<A,S> : SerializerBase, ISystemHandlerSerializationMagicBytes
        where A : class
        where S : SerializerState, new()
    {
        ...
        /// </summary>
        public override string Id => (cnSerializerType + "/" + ToIdentifier()).ToLowerInvariant();
