...
//        /// <param name="connection">The optional document db connection.</param>
//        /// <param name="database">The optional database name. If this is set to null, it will attempt to pick up from configuration.</param>
...
//        public static P AddPersistenceManagerDocumentDb<P,K,E>(this P pipeline
//            , Func<E, K> keyMaker
...
//        {
//            if (keyMaker == null)
//                throw new ArgumentNullException("keyMaker", $"keyMaker cannot be null in {nameof(AddPersistenceManagerDocumentDb)}");
//            if (keyDeserializer == null)
//                throw new ArgumentNullException("keyDeserializer", $"keyDeserializer cannot be null in {nameof(AddPersistenceManagerDocumentDb)}");
//            if (cpipe == null)
//                throw new ArgumentNullException("cpipe", $"cpipe cannot be null in {nameof(AddPersistenceManagerDocumentDb)}");
...
//            var pm = new PersistenceManagerHandlerDocumentDb<K,E>(connection, database, keyMaker, keyDeserializer
