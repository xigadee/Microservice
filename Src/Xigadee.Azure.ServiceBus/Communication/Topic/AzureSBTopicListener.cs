...
namespace Xigadee
{
    ...
    public class AzureServiceBusTopicListener : AzureSBListenerBase<SubscriptionClient, Microsoft.Azure.ServiceBus.Message>
    {
        #region Declarations
        /// <summary>
        ...
        /// </summary>
        public AzureServiceBusTopicListener() { }
        #endregion
        ...
        protected override AzureClientHolder<SubscriptionClient, Microsoft.Azure.ServiceBus.Message> ClientCreate(ListenerPartitionConfig partition)
        {
            ...
            client.Name = mPriorityClientNamer(Connection.ConnectionName, partition.Priority);
