...
namespace Xigadee
{
    public static partial class CorePipelineExtensions
    {
        ...
        /// <param name="redisConnection">This is the optional redis cache connection string. 
        ...
        public static C AttachPersistenceManagerRedisCache<C, K, E>(this C cpipe
            , Func<E, K> keyMaker
        ...
        {
            cpipe.Pipeline.AddPersistenceManagerRedisCache(keyMaker, keyDeserializer, cpipe, redisConnection, startupPriority
