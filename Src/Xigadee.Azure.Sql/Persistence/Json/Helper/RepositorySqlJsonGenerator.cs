...
namespace Xigadee
{
    ...
    public class RepositorySqlJsonGenerator<E>
    {
        ...
        /// 
        /// </summary>
        public virtual string GeneratorVersion => $"-- Generated by {Assembly.GetExecutingAssembly().GetName().Name}/{Assembly.GetExecutingAssembly().GetName().Version.ToString()}";
