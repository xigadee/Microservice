...
//namespace Xigadee
//{
//    public class CommunicationBridge: CommunicationBridge<ManualCommunicationBridgeAgent>
//    {
//        /// <summary>
...
//        public CommunicationBridge(CommunicationBridgeMode mode):base(mode)
//        {
//        }
//    }
//    /// <summary>
...
//    /// </summary>
//    public class CommunicationBridge<A>
//        where A: CommunicationBridgeAgent, new()
//    {
//        #region Constructor
//        /// <summary>
//        /// This is the default constructor that specifies the broadcast mode.
...
//        /// <param name="mode">This property specifies how the bridge communicates to the senders from the listeners.</param>
//        /// <param name="agent">This is the communication agent. When not set this defaults to the manual agent.</param>
//        public CommunicationBridge(CommunicationBridgeMode mode, A agent = null)
//        {
//            Agent = agent ?? new A();
//        }
//        #endregion
