...
namespace Xigadee
{
    ...
    /// </summary>
    public class TcpTlsClientConnector:TcpTlsConnectorBase
    {
        /// <summary>
        ...
        public TcpTlsClientConnector(IPEndPoint endPoint, SslProtocols protocolLevel = SslProtocols.Tls12):base(endPoint,protocolLevel,null)
        {
        }
