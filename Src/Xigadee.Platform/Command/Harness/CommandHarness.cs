...
namespace Xigadee
{
    ...
    public class CommandHarness<C>: ServiceHarness<C, CommandHarnessDependencies<C>>, ICommandHarness 
        where C: class, ICommand
    {
        ...
        /// </summary>
        public IEnumerable<KeyValuePair<long,CommandHarnessTraffic>> Failed => Traffic.Where((t) => !t.Value.IsSuccess);
        #endregion
        #region Outgoing
        /// <summary>
        /// Contains the outgoing commands generated by the command in the order that they were generated.
        /// </summary>
        public IEnumerable<KeyValuePair<long, CommandHarnessTraffic>> Outgoing => Traffic.Where((t) => t.Value.Direction == CommandHarnessTrafficDirection.Outgoing);
        #endregion
