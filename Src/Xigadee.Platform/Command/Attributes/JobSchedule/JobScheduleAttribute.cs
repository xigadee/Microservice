...
namespace Xigadee
{
    ...
    public class JobScheduleAttribute: JobScheduleAttributeBase
    {
        ...
        public JobScheduleAttribute(string initialWait = null, string frequency = null, bool isLongRunningProcess = false, string name = null) 
    ...
    public abstract class JobScheduleAttributeBase: Attribute
    {
        ...
        /// <param name="name">The optional name for the schedule. This will be displayed in the Microservice statistics.</param>
        /// <see cref="https://msdn.microsoft.com/en-us/library/se73z7b9(v=vs.110).aspx"/>
        protected JobScheduleAttributeBase(string initialWait = null, string frequency = null, bool isLongRunningProcess = false, string name = null)
        {
